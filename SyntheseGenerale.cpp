...
QGridLayout* SyntheseGenerale::grp_VbInfo(param_2 prm)
{
...
QTableView * SyntheseGenerale::grp_TbvAnalyse(int zn, QString tb_src, QString tb_ref, QString key)
{
 QString tb_out = QString("r_")+tb_src + QString("_grp_z")+QString::number(zn+1);
