#ifndef BMULTISELECTCOMBOBOX_H
#define BMULTISELECTCOMBOBOX_H

#pragma once
#include <QComboBox>
#include <QListWidget>

class BMultiSelectComboBox : public QComboBox
{
    Q_OBJECT

public:
    BMultiSelectComboBox(QWidget* aParent = Q_NULLPTR);
