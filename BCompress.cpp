...
BCompress::BCompress(QObject *parent) :
    QObject(parent)
{
}

bool BCompress::compressFolder(QString sourceFolder, QString destinationFile)
{
...
bool BCompress::compress(QString sourceFolder, QString prefex)
{
...
bool BCompress::decompressFolder(QString sourceFile, QString destinationFolder)
{
    //validation
