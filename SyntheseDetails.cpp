...
QComboBox *ComboPerso(int id)
{
 ...
 //QTableView *sourceView = new QTableView;
 ...
 //sourceView->horizontalHeader()->hide();
 //sourceView->verticalHeader()->hide();
 //sourceView->hideColumn(1);
...
/// tb2 contient la liste des elements �  chercher
